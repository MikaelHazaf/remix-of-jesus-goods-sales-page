...
const HeroSection = () => {
  return (
    <section className="relative overflow-hidden gradient-warm py-8 sm:py-12 lg:py-20">
      {/* Decorative elements */}
          ...
          <div className="flex-1 text-center lg:text-left order-2 lg:order-1">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 justify-center lg:justify-start">
              <a href={CHECKOUT_URL} target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
                <Button 
                  size="lg" 
                  className="w-full sm:w-auto gradient-cta hover:opacity-90 text-white font-bold text-base sm:text-lg px-6 sm:px-8 py-5 sm:py-6 rounded-xl shadow-lg hover:shadow-xl transition-all group"
                >
                  Quero o Kit Agora
